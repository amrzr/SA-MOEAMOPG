...
parser.add_argument('--save-dir', type=str, default='/scratch/project_2007911/test_runs/new_mujoco_runs/MO-HalfCheetah-v2')
...
for i in range(args.num_seeds):
    ...
    if test_ra:
        cmd = 'python morl/run.py '\
            ...
            '--save-dir {}/ra/{}/{}/ '\
            '--approach {}'\
                .format(seed, save_dir, approach, i, approach)
        commands.append(cmd)
