...
from desdeo_emo.selection.Probabilistic_APD_select import Probabilistic_APD_select
#from desdeo_emo.selection.Hybrid_APD_Select import Hybrid_APD_Select
#from desdeo_emo.selection.APD_Select_constraints import APD_Select

from desdeo_problem import MOProblem


class Probabilistic_RVEA(BaseDecompositionEA):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            reevaluate_parents = reevaluate_parents
        )
        ...
        selection_operator = Probabilistic_APD_select(
            pop=self.population,
...
"""
class Hybrid_RVEA(Probabilistic_RVEA):
    def __init__(
        self,
        problem: MOProblem,
        population_size: int = None,
