...
class Probabilistic_APD_select(InteractiveDecompositionSelectionBase):
    ...
    def do(self, pop: Population) -> List[int]:
        ...
        for i in range(0, len(self.vectors.values)):
            ...
            if len(sub_population_fitness > 0):
                ...
                # Compute rank by utilzing Monte Carlo samples
    ...
    def _partial_penalty_factor(self) -> float:
        ...
        penalty = ((px) ** self.alpha) * self.n_of_fitnesses     
        return penalty
